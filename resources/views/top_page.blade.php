                ...
                <div class="inner">
                    <h5>3º Opção</h5>
                        <p class="subtitle">Asus Zenfone 6</p>
                            <div class="avatar"><img src="/img/asus_zenfone_6.jpg" alt="" class="img-responsive" /></div>
                                <ul class="p_description d-flex justify-content-start">
                                    <li>Câmera:----</li>
                                    <li>Memória RAM:----</li>
                                    <li>Memória Interna:----</li>
                                    <li>Preço:----</li>
                            ...
                            <div class="wow bounceInUp" data-wow-delay="0.2s">
                                <div class="team boxed-grey">
                                    <div class="inner">
                                        ...
                                        <div class="avatar"><img src="/img/samsung_j8.jpg" alt="" class="img-responsive" /></div>
                                        <ul class="p_description d-flex justify-content-start">
                                            <li>Câmera:----</li>
                                            <li>Memória RAM:----</li>
                                            <li>Memória Interna:----</li>
                            ...
                            <div class="wow bounceInUp" data-wow-delay="0.5s">
                                <div class="team boxed-grey">
                                    <div class="inner">
                                        ...
                                        <div class="avatar"><img src="/img/samsung_a50.jpg" alt="" class="img-responsive" /></div>
                                        <ul class="p_description d-flex justify-content-start">
                                            <li>Câmera:----</li>
                                            <li>Memória RAM:----</li>
                                            <li>Memória Interna:----</li>
                            ...
                            <div class="wow bounceInUp" data-wow-delay="0.8s">
                                <div class="team boxed-grey">
                                    <div class="inner">
                                        ...
                                        <div class="avatar"><img src="/img/iphone_10.jpg" alt="" class="img-responsive" /></div>
                                        <ul class="p_description d-flex justify-content-start">
                                            <li>Câmera:----</li>
                                            <li>Memória RAM:----</li>
                                            <li>Memória Interna:----</li>
                            ...
                            <div class="wow bounceInUp" data-wow-delay="0.2s">
                                <div class="team boxed-grey">
                                    <div class="inner">
                                        ...
                                        <div class="avatar"><img src="/img/iphone_8plus.jpg" alt="" class="img-responsive" /></div>
                                        <ul class="p_description d-flex justify-content-start">
                                            <li>Câmera:----</li>
                                            <li>Memória RAM:----</li>
                                            <li>Memória Interna:----</li>
                            ...
                            <div class="wow bounceInUp" data-wow-delay="0.5s">
                                <div class="team boxed-grey">
                                    <div class="inner">
                                        ...
                                        <div class="avatar"><img src="/img/sony_xperia_xz2.jpg" alt="" class="img-responsive" /></div>
                                        <ul class="p_description d-flex justify-content-start">
                                            <li>Câmera:----</li>
                                            <li>Memória RAM:----</li>
                                            <li>Memória Interna:----</li>
                            ...
                            <div class="wow bounceInUp" data-wow-delay="0.8s">
                                <div class="team boxed-grey">
                                    <div class="inner">
                                        ...
                                        <div class="avatar"><img src="/img/huawei_mate_30.jpg" alt="" class="img-responsive" /></div>
                                        <ul class="p_description d-flex justify-content-start">
                                            <li>Câmera:----</li>
                                            <li>Memória RAM:----</li>
                                            <li>Memória Interna:----</li>
                            ...
                            <div class="wow bounceInUp" data-wow-delay="0.2s">
                                <div class="team boxed-grey">
                                    <div class="inner">
                                        ...
                                        <div class="avatar"><img src="/img/lg_kg12.jpg" alt="" class="img-responsive" /></div>
                                        <ul class="p_description">
                                            <li>Câmera:----</li>
                                            <li>Memória RAM:----</li>
                                            <li>Memória Interna:----</li>
                            ...
                            <div class="wow bounceInUp" data-wow-delay="0.5s">
                                <div class="team boxed-grey">
                                    <div class="inner">
                                        ...
                                        <div class="avatar"><img src="/img/huawei_honor.jpg" alt="" class="img-responsive" /></div>
                                        <ul class="p_description">
                                            <li>Câmera:----</li>
                                            <li>Memória RAM:----</li>
                                            <li>Memória Interna:----</li>
                            ...
                            <div class="wow bounceInUp" data-wow-delay="0.8s">
                                <div class="team boxed-grey">
                                    <div class="inner">
                                        ...
                                        <div class="avatar"><img src="/img/sony_xperia_x.jpg" alt="" class="img-responsive" /></div>
                                        <ul class="p_description">
                                            <li>Câmera:----</li>
                                            <li>Memória RAM:----</li>
                                            <li>Memória Interna:----</li>
