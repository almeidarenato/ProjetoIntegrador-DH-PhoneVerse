...
<a name="" id="" class="btn btn-primary" href="#" role="button" data-toggle="modal" data-target="#adicionar">Incluir Novo Sistema Operacional <i class="fa fa-plus" aria-hidden="true"></i></a>
