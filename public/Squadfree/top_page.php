...
<body>
	<header class="section-header">
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container">
				<a class="navbar-brand" href="#"><img class="logo" src="assets/img/productlist/logos/logo-alibaba.png" alt="alibaba style e-commerce html template file" title="alibaba e-commerce html css theme"></a>
			...
			<div class="row-sm">
				<div class="col-md-3 col-sm-6">
					<figure class="card card-product">
						<div class="img-wrap"> <img src="assets/img/productlist/items/1.jpg"></div>
				...
				<div class="col-md-3 col-sm-6">
					<figure class="card card-product">
						<div class="img-wrap"> <img src="assets/img/productlist/items/2.jpg"></div>
						<figcaption class="info-wrap">
				...
				<div class="col-md-3 col-sm-6">
					<figure class="card card-product">
						<div class="img-wrap"> <img src="assets/img/productlist/items/3.jpg"></div>
						<figcaption class="info-wrap">
							<a href="#" class="title">Good item name</a>
							<div class="price-wrap">
								<span class="price-new">$280</span>
				...
				<div class="col-md-3 col-sm-6">
					<figure class="card card-product">
						<div class="img-wrap"> <img src="assets/img/productlist/items/4.jpg"></div>
						<figcaption class="info-wrap">
							<a href="#" class="title">Good item name</a>
							<div class="price-wrap">
								<span class="price-new">$280</span>
				...
				<div class="col-md-3 col-sm-6">
					<figure class="card card-product">
						<div class="img-wrap"> <img src="assets/img/productlist/items/5.jpg"></div>
						<figcaption class="info-wrap">
							<a href="#" class="title">Good item name</a>
							<div class="price-wrap">
								<span class="price-new">$1280</span>
				...
				<div class="col-md-3 col-sm-6">
					<figure class="card card-product">
						<div class="img-wrap"> <img src="assets/img/productlist/items/6.jpg"></div>
						<figcaption class="info-wrap">
							<a href="#" class="title">The name of product</a>
							<div class="price-wrap">
								<span class="price-new">$280</span>
				...
				<div class="col-md-3 col-sm-6">
					<figure class="card card-product">
						<div class="img-wrap"> <img src="assets/img/productlist/items/7.jpg"></div>
						<figcaption class="info-wrap">
							<a href="#" class="title">The name of product</a>
							<div class="price-wrap">
								<span class="price-new">$280</span>
