...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  <section id="intro" class="intro">
    ...
    <div class="slogan">
      <h2><span class="text_color">Bem vindo à Phoneverse. Estamos aqui para ajuda-lo a escolher o Smartphone ideal para sua necessidade.</span> </h2>
      <h3><span class="text_color"> Clique e conheça o seu próximo smartphone</span></h3>
    </div>
        ...
        <div class="wow fadeInUp" data-wow-delay="0.2s">
          <div class="service-box">
            ...
            <div class="service-desc">
              ...
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".me-ajude-a-escolher">Preciso de Ajuda</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="wow fadeInRight" data-wow-delay="0.2s">
          <div class="service-box">
            ...
            <div class="service-desc">
              ...
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".eu-sei">Eu me viro</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="modal fade me-ajude-a-escolher" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <iframe width="100%" height="500" frameborder="0" src="inc/questionario.php"></iframe>
      </div>
    </div>
  </div>
        ...
        <div class="wow fadeInUp" data-wow-delay="0.2s">
          <div class="service-box">
            ...
            <div class="service-desc">
              <h5>Me ajude a escolher</h5>
              <p>Escolhendo esta opção, nós te mostraremos as melhores opções de aparelhos com base em suas respostas em um rápido questionário </p>
              <button type="button" class="buttonsp" data-target="#exampleModal">Quero Esta Opção</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="wow fadeInRight" data-wow-delay="0.2s">
          <div class="service-box">
            ...
            <div class="service-desc">
              ...
              <button type="button" class="buttonsp">Prefiro essa opção</button>
            </div>
          </div>
        </div>
      </div>
