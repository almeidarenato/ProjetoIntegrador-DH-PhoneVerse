...
<head>
	...
	<link href="assets/img/productlist/favicon.ico" rel="shortcut icon" type="image/x-icon">

	<!-- jQuery -->
	<script src="assets/scripts/productlist/jquery-2.0.0.min.js" type="text/javascript"></script>
				...
				<div class="row align-items-center">
					<div class="col-lg-3 col-sm-4">
						<div class="brand-wrap">
							<img class="logo" src="assets/img/productlist/logo-dark.png">
