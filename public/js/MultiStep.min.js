!(function(root, factory) {
    ...
    multiStep.prototype = {
        ...
        _buildMultiStep: function() {
            ...
            var opcao = $element.find("#opcaoUsuario").val();
            $form.append(
        ...
        _buildFooterContent: function() {
            var footer = `<button type="button" class="btn btn-primary ${_prevClass}">${this.options.prevText}</button>
            <button type="button" class="btn btn-primary ${_skipClass}">${this.options.skipText}</button>
            <button type="button" class="btn btn-primary ${_nextClass}">${this.options.nextText}</button>`;
        ...
        _showContent: function(i) {
            // classe que mostra o formulário atual
            var $this = this;
